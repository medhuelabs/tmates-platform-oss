            ...
            if catalog_entries:
                ...
                for entry in catalog_entries:
                    ...
                    available_agents.append({
                        ...
                        "latest_version": entry.get("latest_version") or entry.get("version"),
                        "last_updated": entry.get("last_updated"),
                        "developer_website": entry.get("developer_website"),
                        "privacy_policy": entry.get("privacy_policy"),
                        "avatar_image_url": entry.get("avatar_image_url") or entry.get("icon"),
